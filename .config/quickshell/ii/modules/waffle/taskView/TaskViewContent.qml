                            ...
                            onActiveChanged: {
                                if (active) {
                                    ...
                                    if (root.hoveredWorkspace !== null && root.hoveredWorkspace.workspace !== windowItem.hyprlandClient.workspace.id) {
                                        Hyprland.dispatch(`hl.dsp.window.move({ workspace = "${String(root.hoveredWorkspace.workspace)}", window = "address:\${windowItem.hyprlandClient.address}" })`);
                                    } else {
            ...
            WListView {
                ...
                delegate: TaskViewWorkspace {
                    ...
                    onClicked: {
                        ...
                        Hyprland.dispatch(`hl.dsp.focus({ workspace = "${String(workspaceItem.workspace)}" })`);
                    }
                }
            }
        }
