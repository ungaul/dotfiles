                            ...
                            MouseArea {
                                ...
                                onPressed: {
                                    if (root.draggingTargetWorkspace === -1) {
                                        ...
                                        Hyprland.dispatch(`hl.dsp.focus({ workspace = "${String(workspace.workspaceValue)}" })`)
                                    }
                                }
                            }
                    ...
                    MouseArea {
                        ...
                        onReleased: {
                            ...
                            if (targetWorkspace !== -1 && targetWorkspace !== windowData?.workspace.id) {
                                Hyprland.dispatch(`hl.dsp.window.move({ workspace = "${String(targetWorkspace)}", window = "address:\${window.windowData?.address}" })`)
                                ...
                                Hyprland.dispatch(`hl.dsp.exec_raw("movewindowpixel exact \${percentageX}% \${percentageY}%, address:\${window.windowData?.address}")`)
                            }
                        }
                        onClicked: (event) => {
