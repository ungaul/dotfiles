...
AbstractQuickPanel {
    ...
    // Toggles
    readonly property list<string> availableToggleTypes: ["network", "bluetooth", "idleInhibitor", "nightLight", "darkMode", "gameMode", "screenSnip", "colorPicker", "onScreenKeyboard", "mic", "audio", "notifications", "powerProfile", "musicRecognition", "vpn", "docker"]
                ...
                delegate: ButtonGroup {
                    ...
                    Repeater {
                        ...
                        delegate: AndroidToggleDelegateChooser {
                            ...
                            onOpenDockerDialog: root.openDockerDialog()
                        }
                    }
                }
            }
