...
Scope {
    ...
    IpcHandler {
	    ...
	    function setActive(  ) {
	        GlobalStates.keyboardChatteringActive = true
	        root.currentIndicator = "keyboard"
	        root.triggerOsd()
	    }

	    function setInactive() {
	        GlobalStates.keyboardChatteringActive = false
	        root.currentIndicator = "keyboard"
	        root.triggerOsd()
	    }

	    function toggle() {
	        GlobalStates.keyboardChatteringActive = !GlobalStates.keyboardChatteringActive
	        root.currentIndicator = "keyboard"
	        root.triggerOsd()
	    }
	}
