...
import qs.modules.ii.background.widgets.desktopIcons
...
Variants {
    ...
    PanelWindow {
        ...
        Item {
            ...
            Loader {
                anchors.fill: parent
                active: Config.options.background.widgets.desktopIcons.enable && bgRoot.modelData === Quickshell.screens[0]
                sourceComponent: DesktopIconsWidget {
                    screenWidth: bgRoot.screen.width
                    screenHeight: bgRoot.screen.height
                }
            }
