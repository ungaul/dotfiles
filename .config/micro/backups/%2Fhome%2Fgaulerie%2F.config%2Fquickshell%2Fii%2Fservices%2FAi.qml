...
Singleton {
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        "open-webui": aiModelComponent.createObject(this, {
            "name": "Open WebUI",
            "icon": "google-gemini-symbolic",
            "description": Translation.tr("ai.0x404.org"),
            "homepage": "https://ai.0x404.org",
            "endpoint": "https://ai.0x404.org/api/chat/completions",
            "model": "openai/gpt-5.4-mini",
            "requires_key": true,
            "key_id": "open-webui",
            "key_get_link": "https://ai.0x404.org",
            "key_get_description": Translation.tr("Go to Settings → Account → API Keys"),
            "api_format": "openai",
        }),
    ...
    property string openWebuiChatId: ""
    property bool openWebuiChatInitialized: false
    ...
    function setModel(modelId, feedback = true, setPersistentState = true) {
        ...
        if (modelList.indexOf(modelId) !== -1) {
            ...
            root.openWebuiChatId = "";
            root.openWebuiChatInitialized = false;
    ...
    Process {
        ...
        function makeRequest() {
            ...
            if (model.endpoint.includes("ai.0x404.org") && root.openWebuiChatId.length === 0 && !root.openWebuiChatInitialized) {
                root.openWebuiChatInitialized = true;
                root.ensureOpenWebuiChat(() => {
            ...
            if (model.endpoint.includes("ai.0x404.org") && root.openWebuiChatId.length > 0) {
                data.chat_id = root.openWebuiChatId;
            }
    ...
    function ensureOpenWebuiChat(callback) {
      callback();
    }
